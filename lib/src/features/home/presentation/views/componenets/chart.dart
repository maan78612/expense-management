...
class _Chart extends ConsumerWidget {
            ...
            child: homeViewModel.selectedTab == TabBarEnum.pie
                ? PieChart(
                    PieChartData(
                      ...
                      pieTouchData: homeViewModel.getPieTouchData(context),
                ...
                : SingleChildScrollView(
                    ...
                    child: SizedBox(
                      width: homeViewModel.categories.length * 90,
                      // Adjust width based on number of categories
                      child: BarChart(
                        BarChartData(
                          barGroups: homeViewModel.barChartGroups,
                          titlesData: homeViewModel.barTitlesData(colorMode),
  ...
  Column _categoryList(HomeViewModel homeViewModel, ColorMode colorMode, BuildContext context) {
    return Column(
          children: List.generate(homeViewModel.categories.length, (index) {
            final category = homeViewModel.categories[index];
            final percentage =
                (category.amount / homeViewModel.totalExpenses) * 100;
